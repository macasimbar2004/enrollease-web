...
class _LogoutDialogState extends State<LogoutDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: loading ? const SizedBox(width: 50, height: 50, child: Center(child: CircularProgressIndicator())) : const Text('Are you sure you want to logout?'),
      actions: <Widget>[
        TextButton(
        ...
        TextButton(
          onPressed: () async {
            ...
            await FirebaseAuthProvider().addNotification(
                content: 'Registrar ${registrar.firstName} ${registrar.lastName} has logged out.\n'
